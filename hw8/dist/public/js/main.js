...
var cart = {
  ...
  methods: {
    ...
    removeProduct: function removeProduct(element) {
      ...
      var find = this.cart.find(function (el) {
        return el.id_product === element.id_product;
      });
      ...
      if (find.quantity > 1) {
        ...
        this.$parent.putJSON("/api/cart/".concat(find.id_product), {
          ...
          if (data.result) {
            _this2.cart.splice(_this2.cart.indexOf(element), 1);
          }
        });
      }
    }
...
/* harmony import */ var _ProdComp_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ProdComp_js__WEBPACK_IMPORTED_MODULE_1__);
...
var app = {
  ...
  components: {
    products: _ProdComp_js__WEBPACK_IMPORTED_MODULE_1___default.a,
    cart: _CartComp_js__WEBPACK_IMPORTED_MODULE_0__["default"],
    filterEl: _FilterComp_js__WEBPACK_IMPORTED_MODULE_3__["default"],
